...
class SearchResultsPage(BasePage):
    ...
    def first_link(self):
        self.browser.find_element(By.CSS_SELECTOR, self.link_selector).click()
    ...
    def search_result_links_on_page(self):
        ...
        search_result_selectors_list = self.browser.find_elements(By.CSS_SELECTOR, self.link_selector)
